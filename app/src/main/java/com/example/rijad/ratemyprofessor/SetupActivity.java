...
public class SetupActivity extends AppCompatActivity {
    ...
    private EditText UserName, FullName, FacultyName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FacultyName = (EditText) findViewById(R.id.setup_faculty_name);
    ...
    private void SaveAccountSetupInformation() {
        ...
        String faculty = FacultyName.getText().toString();
        ...
        {
            Toast.makeText(this, "Please write your faculty...", Toast.LENGTH_SHORT).show();
        }
        else
        {
            ...
            userMap.put("status", "I'm the man, down is a legend.");
            userMap.put("gender", "none");
            userMap.put("dob", "none");
            userMap.put("studystatus", "none");
