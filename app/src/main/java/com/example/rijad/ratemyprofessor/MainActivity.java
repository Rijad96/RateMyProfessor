...
public class MainActivity extends AppCompatActivity
{
    ...
    private void DisplayAllUsersPosts()
    {
        FirebaseRecyclerAdapter<Posts, PostsViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Posts, PostsViewHolder>
            ...
            protected void populateViewHolder(PostsViewHolder viewHolder, Posts model, int position) {
                ...
                viewHolder.likeButtonStatus(PostKey);
                viewHolder.dislikeButtonStatus(PostKey);
                ...
                viewHolder.DislikepostButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        DislikeChecker = true;
    ...
    public static class PostsViewHolder extends RecyclerView.ViewHolder
    {
        ...
        ImageButton LikepostButton, DislikepostButton, CommentpostButton;
        TextView DisplayOfLikes, DisplayOfDislikes;
        ...
        public PostsViewHolder(View itemView)
        {
            ...
            DisplayOfLikes = (TextView) mView.findViewById(R.id.number_of_likes);
            DisplayOfDislikes = (TextView) mView.findViewById(R.id.number_of_dislikes);
        ...
        public void likeButtonStatus(final String PostKey){
            LikesRef.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if(dataSnapshot.child(PostKey).hasChild(currentUserId)){
                        countLikes = (int) dataSnapshot.child(PostKey).getChildrenCount();
                        DisplayOfLikes.setText(Integer.toString(countLikes)+(" ")+("Likes"));
                    }
                    else{
                        countLikes = (int) dataSnapshot.child(PostKey).getChildrenCount();
                        DisplayOfLikes.setText(Integer.toString(countLikes)+(" ")+("Likes"));
        ...
        public void dislikeButtonStatus(final String PostKey){
            DislikesRef.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if(dataSnapshot.child(PostKey).hasChild(currentUserId)){
                        countDislikes = (int) dataSnapshot.child(PostKey).getChildrenCount();
                        DisplayOfDislikes.setText(Integer.toString(countDislikes)+(" ")+("Dislikes"));
                    }
                    else{
                        countDislikes = (int) dataSnapshot.child(PostKey).getChildrenCount();
                        DisplayOfDislikes.setText(Integer.toString(countDislikes)+(" ")+("Dislikes"));
    ...
    private void UserMenuSelector (MenuItem item){
        switch (item.getItemId())
        {
            ...
            case R.id.nav_faculty:
                ...
                break;
            case R.id.nav_my_professors:
                Toast.makeText(this,"My Professors", Toast.LENGTH_SHORT).show();
                break;
            case R.id.nav_find_professors:
                Toast.makeText(this,"Find Professor", Toast.LENGTH_SHORT).show();
                break;
